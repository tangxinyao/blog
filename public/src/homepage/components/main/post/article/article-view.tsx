...
export function ArticleView() {
    return <article className="article">Stop all the clocks, cut off the telephone, Prevent the dog from barking with a juicy bone,
        ...
        my talk, my song; I thought that love would last forever; I was wrong.
        The stars are not wanted now: put out every one; Pack up the moon and dismantle the sun;
        Pour away the ocean and sweep up the wood; For nothing now can ever come to any good.</article>;
}
